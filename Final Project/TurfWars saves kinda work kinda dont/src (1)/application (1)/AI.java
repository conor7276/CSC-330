...
//		int CPUact = random_opt.nextInt(4);
		...
		else if(this.GetNorth().getURL().equals("Assets/Purple_Slime_Icon.png") ||
				this.GetNorth().getURL().equals("Assets/Blue_Slime_Icon.png") || 
				this.GetNorth().getURL().equals("Assets/Green_Slime_Icon.png") ||
				this.GetNorth().getURL().equals("Assets/Pink_Slime_Icon.png")) {
			System.out.println(this.getURL() + " Cannot go north");
			options.remove("North");
		...
		else if(this.GetSouth().getURL().equals("Assets/Purple_Slime_Icon.png") ||
				this.GetSouth().getURL().equals("Assets/Blue_Slime_Icon.png") || 
				this.GetSouth().getURL().equals("Assets/Green_Slime_Icon.png") ||
				this.GetSouth().getURL().equals("Assets/Pink_Slime_Icon.png"))
		{
		...
		else if(this.GetEast().getURL().equals("Assets/Purple_Slime_Icon.png") ||
				this.GetEast().getURL().equals("Assets/Blue_Slime_Icon.png") || 
				this.GetEast().getURL().equals("Assets/Green_Slime_Icon.png") ||
				this.GetEast().getURL().equals("Assets/Pink_Slime_Icon.png"))
		{
			System.out.println(this.getURL() + " Cannot go east");
			options.remove("East");
		}
		...
		else if(this.GetWest().getURL().equals("Assets/Purple_Slime_Icon.png") ||
				this.GetWest().getURL().equals("Assets/Blue_Slime_Icon.png") || 
				this.GetWest().getURL().equals("Assets/Green_Slime_Icon.png") ||
				this.GetWest().getURL().equals("Assets/Pink_Slime_Icon.png"))
		{
			System.out.println(this.getURL() + " Cannot go west");
			options.remove("West");
		}
		...
		if(other_tiles.size() != 0) { // prioritize other tile colors
			...
			if((dir == "North" && this.GetNorth().getURL().equals("Assets/V_laser_tile.jpg")) || (dir == "North" && this.GetNorth().getURL().equals("Assets/H_laser_tile.jpg")) || (dir == "North" && this.GetNorth().getURL().equals("Assets/Bomb_tile.jpg"))) {
				System.out.println(this.GetNorth().getURL() + " has been picked up!");
				if(this.GetNorth().getURL().equals("Assets/V_laser_tile.jpg")) {
				...
				else if(this.GetNorth().getURL().equals("Assets/H_laser_tile.jpg")) {
					
					updated_state = moveNorth(updated_state);
					Horizontal_Beam h = new Horizontal_Beam();
					updated_state = h.Use(updated_state, this.getURL(),this.getLocation(), this);
				}
				else if(this.GetNorth().getURL().equals("Assets/Bomb_tile.jpg")) {
			...
			else if((dir == "South" && this.GetSouth().getURL().equals("Assets/V_laser_tile.jpg")) || (dir == "South" && this.GetSouth().getURL().equals("Assets/H_laser_tile.jpg")) || (dir == "South" && this.GetSouth().getURL().equals("Assets/Bomb_tile.jpg"))) {
				System.out.println(this.GetSouth().getURL() + " has been picked up!");
				if(this.GetSouth().getURL().equals("Assets/V_laser_tile.jpg")) {
					updated_state = moveSouth(updated_state);
					Vertical_Beam v = new Vertical_Beam();
					updated_state = v.Use(updated_state, this.getURL(),this.getLocation(), this);
				}
				else if(this.GetSouth().getURL().equals("Assets/H_laser_tile.jpg")) {
					updated_state = moveSouth(updated_state);
					Horizontal_Beam h = new Horizontal_Beam();
					updated_state = h.Use(updated_state, this.getURL(),this.getLocation(), this);
				}
				else if(this.GetSouth().getURL().equals("Assets/Bomb_tile.jpg")) {
					updated_state = moveSouth(updated_state);
					Bomb b = new Bomb();
					updated_state = b.Use(updated_state,this.getURL(),this.getLocation(), this);
				}
			...
			else if((dir == "East" && this.GetEast().getURL().equals("Assets/V_laser_tile.jpg")) || (dir == "East" && this.GetEast().getURL().equals("Assets/H_laser_tile.jpg")) || (dir == "East" && this.GetEast().getURL().equals("Assets/Bomb_tile.jpg"))) {
				System.out.println(this.GetEast().getURL() + " has been picked up!");
				if(this.GetEast().getURL().equals("Assets/V_laser_tile.jpg")) {
					updated_state = moveEast(updated_state);
					Vertical_Beam v = new Vertical_Beam();
					updated_state = v.Use(updated_state, this.getURL(),this.getLocation(), this);
				}
				else if(this.GetEast().getURL().equals("Assets/H_laser_tile.jpg")) {
					updated_state = moveEast(updated_state);
					Horizontal_Beam h = new Horizontal_Beam();
					updated_state = h.Use(updated_state, this.getURL(),this.getLocation(), this);
				}
				else if(this.GetEast().getURL().equals("Assets/Bomb_tile.jpg")) {
					updated_state = moveEast(updated_state);
					Bomb b = new Bomb();
					updated_state = b.Use(updated_state,this.getURL(),this.getLocation(), this);
				}
			...
			else if((dir == "West" && this.GetWest().getURL().equals("Assets/V_laser_tile.jpg")) || (dir == "West" && this.GetWest().getURL().equals("Assets/H_laser_tile.jpg")) || (dir == "West" && this.GetWest().getURL().equals("Assets/Bomb_tile.jpg"))) {
				System.out.println(this.GetWest().getURL() + " has been picked up!");
				if(this.GetWest().getURL().equals("Assets/V_laser_tile.jpg")) {
					updated_state = moveWest(updated_state);
					Vertical_Beam v = new Vertical_Beam();
					updated_state = v.Use(updated_state, this.getURL(),this.getLocation(), this);
				}
				else if(this.GetWest().getURL().equals("Assets/H_laser_tile.jpg")) {
					updated_state = moveWest(updated_state);
					Horizontal_Beam h = new Horizontal_Beam();
					updated_state = h.Use(updated_state, this.getURL(),this.getLocation(), this);
				}
				else if(this.GetWest().getURL().equals("Assets/Bomb_tile.jpg")) {
					updated_state = moveWest(updated_state);
					Bomb b = new Bomb();
					updated_state = b.Use(updated_state,this.getURL(),this.getLocation(), this);
				}
