...
public class User extends PlayerSuper{
	...
	File move_sound_location = new File("Assets/movment_splat.mp3");
	/**
	 * @param updated_state passing thorugh the gameboard
	 * @param direction the direction the player will go in
	 * @return updated grid square with the updated movement
	 */
	@Override
	public GridSquare[][] Movement(GridSquare[][] updated_state, String direction) {
	    ...
	    else if(this.GetWest().getURL().equals("Assets/V_laser_tile.jpg") == true || this.GetWest().getURL().equals("Assets/Bomb_tile.jpg") == true|| this.GetWest().getURL().equals("Assets/H_laser_tile.jpg") == true)
	    {
	    	...
	    	move_sound = null;
			move_sound = new MediaPlayer(new Media(move_sound_location.toURI().toString()));
